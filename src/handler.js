...
// Mengimpor fungsi `nanoid` dari pustaka 'nanoid' untuk membuat ID unik.
...
const addBookHandler = (request, h) => {
  ...
  // Memeriksa apakah buku berhasil ditambahkan dengan mencari ID di dalam 'books'.
...
const editBookByIdHandler = (request, h) => {
  ...
  if (index !== -1) {
    // Mengupdate buku yang sesuai dengan ID yang diberikan.
    books[index] = {
      ...books[index],
      name,
      year,
